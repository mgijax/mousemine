...
public class SyntenicRegionShadow implements SyntenicRegion, ShadowClass
{
    ...
    // Ref: org.intermine.model.bio.SyntenicRegion.partner
    protected org.intermine.model.InterMineObject partner;
    public org.intermine.model.bio.SyntenicRegion getPartner() { if (partner instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.SyntenicRegion) ((org.intermine.objectstore.proxy.ProxyReference) partner).getObject()); }; return (org.intermine.model.bio.SyntenicRegion) partner; }
    public void setPartner(final org.intermine.model.bio.SyntenicRegion partner) { this.partner = partner; }
    public void proxyPartner(final org.intermine.objectstore.proxy.ProxyReference partner) { this.partner = partner; }
    public org.intermine.model.InterMineObject proxGetPartner() { return partner; }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("partner".equals(fieldName)) {
            partner = (org.intermine.model.InterMineObject) value;
    ...
    public StringConstructor getoBJECT() {
        ...
        if (partner != null) {
            sb.append("$_^rpartner$_^").append(partner.getId());
        }
        if (length != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) &&"rpartner".equals(notXml[i])) {
                i++;
                partner = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.SyntenicRegion.class);
                i++;
            };
