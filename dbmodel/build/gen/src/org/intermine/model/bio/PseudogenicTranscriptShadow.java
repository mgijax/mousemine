...
public class PseudogenicTranscriptShadow implements PseudogenicTranscript, ShadowClass
{
    public static final Class<PseudogenicTranscript> shadowOf = PseudogenicTranscript.class;
    // Ref: org.intermine.model.bio.PseudogenicTranscript.pseudogene
    protected org.intermine.model.InterMineObject pseudogene;
    public org.intermine.model.bio.Pseudogene getPseudogene() { if (pseudogene instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.Pseudogene) ((org.intermine.objectstore.proxy.ProxyReference) pseudogene).getObject()); }; return (org.intermine.model.bio.Pseudogene) pseudogene; }
    public void setPseudogene(final org.intermine.model.bio.Pseudogene pseudogene) { this.pseudogene = pseudogene; }
    public void proxyPseudogene(final org.intermine.objectstore.proxy.ProxyReference pseudogene) { this.pseudogene = pseudogene; }
    public org.intermine.model.InterMineObject proxGetPseudogene() { return pseudogene; }

    // Col: org.intermine.model.bio.PseudogenicTranscript.pseudogenicExons
    protected java.util.Set<org.intermine.model.bio.PseudogenicExon> pseudogenicExons = new java.util.HashSet<org.intermine.model.bio.PseudogenicExon>();
    public java.util.Set<org.intermine.model.bio.PseudogenicExon> getPseudogenicExons() { return pseudogenicExons; }
    public void setPseudogenicExons(final java.util.Set<org.intermine.model.bio.PseudogenicExon> pseudogenicExons) { this.pseudogenicExons = pseudogenicExons; }
    public void addPseudogenicExons(final org.intermine.model.bio.PseudogenicExon arg) { pseudogenicExons.add(arg); }
    ...
    @Override public boolean equals(Object o) { return (o instanceof PseudogenicTranscript && id != null) ? id.equals(((PseudogenicTranscript)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "PseudogenicTranscript [chromosome=" + (chromosome == null ? "null" : (chromosome.getId() == null ? "no id" : chromosome.getId().toString())) + ", chromosomeLocation=" + (chromosomeLocation == null ? "null" : (chromosomeLocation.getId() == null ? "no id" : chromosomeLocation.getId().toString())) + ", id=\"" + id + "\", length=\"" + length + "\", name=\"" + name + "\", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=\"" + primaryIdentifier + "\", pseudogene=" + (pseudogene == null ? "null" : (pseudogene.getId() == null ? "no id" : pseudogene.getId().toString())) + ", score=\"" + score + "\", scoreType=\"" + scoreType + "\", secondaryIdentifier=\"" + secondaryIdentifier + "\", sequence=" + (sequence == null ? "null" : (sequence.getId() == null ? "no id" : sequence.getId().toString())) + ", sequenceOntologyTerm=" + (sequenceOntologyTerm == null ? "null" : (sequenceOntologyTerm.getId() == null ? "no id" : sequenceOntologyTerm.getId().toString())) + ", symbol=\"" + symbol + "\"]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        if ("pseudogene".equals(fieldName)) {
            if (pseudogene instanceof ProxyReference) {
                return ((ProxyReference) pseudogene).getObject();
            } else {
                return pseudogene;
            }
        }
        if ("pseudogenicExons".equals(fieldName)) {
            return pseudogenicExons;
        }
        ...
        if (!org.intermine.model.bio.PseudogenicTranscript.class.equals(getClass())) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("pseudogene".equals(fieldName)) {
            pseudogene = (org.intermine.model.InterMineObject) value;
        } else if ("pseudogenicExons".equals(fieldName)) {
            pseudogenicExons = (java.util.Set) value;
    ...
    public Class<?> getFieldType(final String fieldName) {
        if ("pseudogene".equals(fieldName)) {
            return org.intermine.model.bio.Pseudogene.class;
        }
        if ("pseudogenicExons".equals(fieldName)) {
        ...
        if (!org.intermine.model.bio.PseudogenicTranscript.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.PseudogenicTranscript.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.PseudogenicTranscriptShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.PseudogenicTranscript");
        if (pseudogene != null) {
            sb.append("$_^rpseudogene$_^").append(pseudogene.getId());
        }
        if (length != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.PseudogenicTranscriptShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.PseudogenicTranscript)");
        }
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) &&"rpseudogene".equals(notXml[i])) {
                i++;
                pseudogene = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.Pseudogene.class);
                i++;
            };
        ...
        pseudogenicExons = new ProxyCollection<org.intermine.model.bio.PseudogenicExon>(os, this, "pseudogenicExons", org.intermine.model.bio.PseudogenicExon.class);
    ...
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("pseudogenicExons".equals(fieldName)) {
            pseudogenicExons.add((org.intermine.model.bio.PseudogenicExon) element);
        } else if ("alleles".equals(fieldName)) {
    ...
    public Class<?> getElementType(final String fieldName) {
        if ("pseudogenicExons".equals(fieldName)) {
            return org.intermine.model.bio.PseudogenicExon.class;
        }
        if ("alleles".equals(fieldName)) {
        ...
        if (!org.intermine.model.bio.PseudogenicTranscript.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.PseudogenicTranscript.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
