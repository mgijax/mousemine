...
public class MatchShadow implements Match, ShadowClass
{
    public static final Class<Match> shadowOf = Match.class;
    // Col: org.intermine.model.bio.Match.matchParts
    protected java.util.Set<org.intermine.model.bio.MatchPart> matchParts = new java.util.HashSet<org.intermine.model.bio.MatchPart>();
    public java.util.Set<org.intermine.model.bio.MatchPart> getMatchParts() { return matchParts; }
    public void setMatchParts(final java.util.Set<org.intermine.model.bio.MatchPart> matchParts) { this.matchParts = matchParts; }
    public void addMatchParts(final org.intermine.model.bio.MatchPart arg) { matchParts.add(arg); }
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.Match.class.equals(getClass())) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("matchParts".equals(fieldName)) {
            matchParts = (java.util.Set) value;
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.Match.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.Match.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.MatchShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.Match");
        if (length != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.MatchShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.Match)");
        }
        ...
        matchParts = new ProxyCollection<org.intermine.model.bio.MatchPart>(os, this, "matchParts", org.intermine.model.bio.MatchPart.class);
    ...
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("matchParts".equals(fieldName)) {
            matchParts.add((org.intermine.model.bio.MatchPart) element);
        } else if ("alleles".equals(fieldName)) {
    ...
    public Class<?> getElementType(final String fieldName) {
        if ("matchParts".equals(fieldName)) {
            return org.intermine.model.bio.MatchPart.class;
        }
        if ("alleles".equals(fieldName)) {
        ...
        if (!org.intermine.model.bio.Match.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.Match.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
