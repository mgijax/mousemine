...
public class SynonymShadow implements Synonym, ShadowClass
{
    public static final Class<Synonym> shadowOf = Synonym.class;
    ...
    @Override public boolean equals(Object o) { return (o instanceof Synonym && id != null) ? id.equals(((Synonym)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "Synonym [id=\"" + id + "\", subject=" + (subject == null ? "null" : (subject.getId() == null ? "no id" : subject.getId().toString())) + ", value=\"" + value + "\"]"; }
    ...
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.SynonymShadow.class.equals(getClass())) {
