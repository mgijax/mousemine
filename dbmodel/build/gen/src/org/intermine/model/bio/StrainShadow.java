...
public class StrainShadow implements Strain, ShadowClass
{
    ...
    // Attr: org.intermine.model.bio.Strain.strainType
    protected java.lang.String strainType;
    public java.lang.String getStrainType() { return strainType; }
    public void setStrainType(final java.lang.String strainType) { this.strainType = strainType; }

    // Col: org.intermine.model.bio.Strain.genotypes
    ...
    @Override public String toString() { return "Strain [id=\"" + id + "\", name=\"" + name + "\", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=\"" + primaryIdentifier + "\", secondaryIdentifier=\"" + secondaryIdentifier + "\", strainType=\"" + strainType + "\", symbol=\"" + symbol + "\"]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        if ("strainType".equals(fieldName)) {
            return strainType;
        }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("strainType".equals(fieldName)) {
            strainType = (java.lang.String) value;
    ...
    public StringConstructor getoBJECT() {
        ...
        if (strainType != null) {
            sb.append("$_^astrainType$_^");
            String string = strainType;
            while (string != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) && "astrainType".equals(notXml[i])) {
                i++;
                ...
                strainType = string == null ? notXml[i] : string.toString();
                i++;
            }
