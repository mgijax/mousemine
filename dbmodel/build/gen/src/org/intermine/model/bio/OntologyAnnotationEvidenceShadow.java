...
public class OntologyAnnotationEvidenceShadow implements OntologyAnnotationEvidence, ShadowClass
{
    public static final Class<OntologyAnnotationEvidence> shadowOf = OntologyAnnotationEvidence.class;
    ...
    @Override public boolean equals(Object o) { return (o instanceof OntologyAnnotationEvidence && id != null) ? id.equals(((OntologyAnnotationEvidence)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "OntologyAnnotationEvidence [annotation=" + (annotation == null ? "null" : (annotation.getId() == null ? "no id" : annotation.getId().toString())) + ", code=" + (code == null ? "null" : (code.getId() == null ? "no id" : code.getId().toString())) + ", id=\"" + id + "\", inferredFrom=\"" + inferredFrom + "\"]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.OntologyAnnotationEvidence.class.equals(getClass())) {
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.OntologyAnnotationEvidence.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.OntologyAnnotationEvidence.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.OntologyAnnotationEvidenceShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.OntologyAnnotationEvidence");
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.OntologyAnnotationEvidenceShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.OntologyAnnotationEvidence)");
        }
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.OntologyAnnotationEvidence.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.OntologyAnnotationEvidence.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
