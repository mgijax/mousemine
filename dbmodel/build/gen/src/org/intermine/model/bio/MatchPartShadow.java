...
public class MatchPartShadow implements MatchPart, ShadowClass
{
    public static final Class<MatchPart> shadowOf = MatchPart.class;
    // Ref: org.intermine.model.bio.MatchPart.match
    protected org.intermine.model.InterMineObject match;
    public org.intermine.model.bio.Match getMatch() { if (match instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.Match) ((org.intermine.objectstore.proxy.ProxyReference) match).getObject()); }; return (org.intermine.model.bio.Match) match; }
    public void setMatch(final org.intermine.model.bio.Match match) { this.match = match; }
    public void proxyMatch(final org.intermine.objectstore.proxy.ProxyReference match) { this.match = match; }
    public org.intermine.model.InterMineObject proxGetMatch() { return match; }
    ...
    @Override public boolean equals(Object o) { return (o instanceof MatchPart && id != null) ? id.equals(((MatchPart)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "MatchPart [chromosome=" + (chromosome == null ? "null" : (chromosome.getId() == null ? "no id" : chromosome.getId().toString())) + ", chromosomeLocation=" + (chromosomeLocation == null ? "null" : (chromosomeLocation.getId() == null ? "no id" : chromosomeLocation.getId().toString())) + ", id=\"" + id + "\", length=\"" + length + "\", match=" + (match == null ? "null" : (match.getId() == null ? "no id" : match.getId().toString())) + ", name=\"" + name + "\", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=\"" + primaryIdentifier + "\", score=\"" + score + "\", scoreType=\"" + scoreType + "\", secondaryIdentifier=\"" + secondaryIdentifier + "\", sequence=" + (sequence == null ? "null" : (sequence.getId() == null ? "no id" : sequence.getId().toString())) + ", sequenceOntologyTerm=" + (sequenceOntologyTerm == null ? "null" : (sequenceOntologyTerm.getId() == null ? "no id" : sequenceOntologyTerm.getId().toString())) + ", symbol=\"" + symbol + "\"]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        if ("match".equals(fieldName)) {
            if (match instanceof ProxyReference) {
                return ((ProxyReference) match).getObject();
            } else {
                return match;
            }
        }
        ...
        if (!org.intermine.model.bio.MatchPart.class.equals(getClass())) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("match".equals(fieldName)) {
            match = (org.intermine.model.InterMineObject) value;
    ...
    public Class<?> getFieldType(final String fieldName) {
        if ("match".equals(fieldName)) {
            return org.intermine.model.bio.Match.class;
        }
        if ("length".equals(fieldName)) {
        ...
        if (!org.intermine.model.bio.MatchPart.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.MatchPart.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.MatchPartShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.MatchPart");
        if (match != null) {
            sb.append("$_^rmatch$_^").append(match.getId());
        }
        if (length != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.MatchPartShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.MatchPart)");
        }
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) &&"rmatch".equals(notXml[i])) {
                i++;
                match = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.Match.class);
                i++;
            };
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.MatchPart.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.MatchPart.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
