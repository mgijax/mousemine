...
public class StartCodonShadow implements StartCodon, ShadowClass
{
    ...
    // Ref: org.intermine.model.bio.StartCodon.CDS
    protected org.intermine.model.InterMineObject CDS;
    public org.intermine.model.bio.CDS getcDS() { if (CDS instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.CDS) ((org.intermine.objectstore.proxy.ProxyReference) CDS).getObject()); }; return (org.intermine.model.bio.CDS) CDS; }
    public void setcDS(final org.intermine.model.bio.CDS CDS) { this.CDS = CDS; }
    public void proxycDS(final org.intermine.objectstore.proxy.ProxyReference CDS) { this.CDS = CDS; }
    public org.intermine.model.InterMineObject proxGetcDS() { return CDS; }

    // Ref: org.intermine.model.bio.StartCodon.transcript
    ...
    @Override public String toString() { return "StartCodon [CDS=" + (CDS == null ? "null" : (CDS.getId() == null ? "no id" : CDS.getId().toString())) + ", chromosome=" + (chromosome == null ? "null" : (chromosome.getId() == null ? "no id" : chromosome.getId().toString())) + ", chromosomeLocation=" + (chromosomeLocation == null ? "null" : (chromosomeLocation.getId() == null ? "no id" : chromosomeLocation.getId().toString())) + ", id=\"" + id + "\", length=\"" + length + "\", name=\"" + name + "\", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=\"" + primaryIdentifier + "\", score=\"" + score + "\", scoreType=\"" + scoreType + "\", secondaryIdentifier=\"" + secondaryIdentifier + "\", sequence=" + (sequence == null ? "null" : (sequence.getId() == null ? "no id" : sequence.getId().toString())) + ", sequenceOntologyTerm=" + (sequenceOntologyTerm == null ? "null" : (sequenceOntologyTerm.getId() == null ? "no id" : sequenceOntologyTerm.getId().toString())) + ", symbol=\"" + symbol + "\", transcript=" + (transcript == null ? "null" : (transcript.getId() == null ? "no id" : transcript.getId().toString())) + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        if ("CDS".equals(fieldName)) {
            if (CDS instanceof ProxyReference) {
                return ((ProxyReference) CDS).getObject();
            } else {
                return CDS;
            }
        }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("CDS".equals(fieldName)) {
            CDS = (org.intermine.model.InterMineObject) value;
    ...
    public StringConstructor getoBJECT() {
        ...
        if (CDS != null) {
            sb.append("$_^rCDS$_^").append(CDS.getId());
        }
        if (transcript != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) &&"rCDS".equals(notXml[i])) {
                i++;
                CDS = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.CDS.class);
                i++;
            };
