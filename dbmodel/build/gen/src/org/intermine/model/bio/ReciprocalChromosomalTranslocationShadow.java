...
public class ReciprocalChromosomalTranslocationShadow implements ReciprocalChromosomalTranslocation, ShadowClass
{
    public static final Class<ReciprocalChromosomalTranslocation> shadowOf = ReciprocalChromosomalTranslocation.class;
    // Ref: org.intermine.model.bio.ChromosomeStructureVariation.chromosome
    ...
    @Override public boolean equals(Object o) { return (o instanceof ReciprocalChromosomalTranslocation && id != null) ? id.equals(((ReciprocalChromosomalTranslocation)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "ReciprocalChromosomalTranslocation [chromosome=" + (chromosome == null ? "null" : (chromosome.getId() == null ? "no id" : chromosome.getId().toString())) + ", id=\"" + id + "\", name=\"" + name + "\", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=\"" + primaryIdentifier + "\", secondaryIdentifier=\"" + secondaryIdentifier + "\", sequenceOntologyTerm=" + (sequenceOntologyTerm == null ? "null" : (sequenceOntologyTerm.getId() == null ? "no id" : sequenceOntologyTerm.getId().toString())) + ", symbol=\"" + symbol + "\"]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.ReciprocalChromosomalTranslocation.class.equals(getClass())) {
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.ReciprocalChromosomalTranslocation.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.ReciprocalChromosomalTranslocation.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.ReciprocalChromosomalTranslocationShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.ReciprocalChromosomalTranslocation");
        if (chromosome != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.ReciprocalChromosomalTranslocationShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.ReciprocalChromosomalTranslocation)");
        }
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.ReciprocalChromosomalTranslocation.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.ReciprocalChromosomalTranslocation.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
