...
public class PseudogenicExonShadow implements PseudogenicExon, ShadowClass
{
    public static final Class<PseudogenicExon> shadowOf = PseudogenicExon.class;
    // Ref: org.intermine.model.bio.PseudogenicExon.pseudogenicTranscript
    protected org.intermine.model.InterMineObject pseudogenicTranscript;
    public org.intermine.model.bio.PseudogenicTranscript getPseudogenicTranscript() { if (pseudogenicTranscript instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.PseudogenicTranscript) ((org.intermine.objectstore.proxy.ProxyReference) pseudogenicTranscript).getObject()); }; return (org.intermine.model.bio.PseudogenicTranscript) pseudogenicTranscript; }
    public void setPseudogenicTranscript(final org.intermine.model.bio.PseudogenicTranscript pseudogenicTranscript) { this.pseudogenicTranscript = pseudogenicTranscript; }
    public void proxyPseudogenicTranscript(final org.intermine.objectstore.proxy.ProxyReference pseudogenicTranscript) { this.pseudogenicTranscript = pseudogenicTranscript; }
    public org.intermine.model.InterMineObject proxGetPseudogenicTranscript() { return pseudogenicTranscript; }
    ...
    @Override public boolean equals(Object o) { return (o instanceof PseudogenicExon && id != null) ? id.equals(((PseudogenicExon)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "PseudogenicExon [chromosome=" + (chromosome == null ? "null" : (chromosome.getId() == null ? "no id" : chromosome.getId().toString())) + ", chromosomeLocation=" + (chromosomeLocation == null ? "null" : (chromosomeLocation.getId() == null ? "no id" : chromosomeLocation.getId().toString())) + ", id=\"" + id + "\", length=\"" + length + "\", name=\"" + name + "\", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=\"" + primaryIdentifier + "\", pseudogenicTranscript=" + (pseudogenicTranscript == null ? "null" : (pseudogenicTranscript.getId() == null ? "no id" : pseudogenicTranscript.getId().toString())) + ", score=\"" + score + "\", scoreType=\"" + scoreType + "\", secondaryIdentifier=\"" + secondaryIdentifier + "\", sequence=" + (sequence == null ? "null" : (sequence.getId() == null ? "no id" : sequence.getId().toString())) + ", sequenceOntologyTerm=" + (sequenceOntologyTerm == null ? "null" : (sequenceOntologyTerm.getId() == null ? "no id" : sequenceOntologyTerm.getId().toString())) + ", symbol=\"" + symbol + "\"]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        if ("pseudogenicTranscript".equals(fieldName)) {
            if (pseudogenicTranscript instanceof ProxyReference) {
                return ((ProxyReference) pseudogenicTranscript).getObject();
            } else {
                return pseudogenicTranscript;
            }
        }
        ...
        if (!org.intermine.model.bio.PseudogenicExon.class.equals(getClass())) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("pseudogenicTranscript".equals(fieldName)) {
            pseudogenicTranscript = (org.intermine.model.InterMineObject) value;
    ...
    public Class<?> getFieldType(final String fieldName) {
        if ("pseudogenicTranscript".equals(fieldName)) {
            return org.intermine.model.bio.PseudogenicTranscript.class;
        }
        if ("length".equals(fieldName)) {
        ...
        if (!org.intermine.model.bio.PseudogenicExon.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.PseudogenicExon.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.PseudogenicExonShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.PseudogenicExon");
        if (pseudogenicTranscript != null) {
            sb.append("$_^rpseudogenicTranscript$_^").append(pseudogenicTranscript.getId());
        }
        if (length != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.PseudogenicExonShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.PseudogenicExon)");
        }
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) &&"rpseudogenicTranscript".equals(notXml[i])) {
                i++;
                pseudogenicTranscript = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.PseudogenicTranscript.class);
                i++;
            };
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.PseudogenicExon.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.PseudogenicExon.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
