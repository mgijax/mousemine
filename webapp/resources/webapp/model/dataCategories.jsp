...
<div class="body">
<im:boxarea title="MouseMine" stylename="plainbox"><p><fmt:message key="dataCategories.intro"/></p></im:boxarea>
...
<table cellpadding="0" cellspacing="0" border="0" class="dbsources">
  ...
  <tr>
    ...
    <td> 
    <a href="http://www.ncbi.nlm.nih.gov/homologene/" target="_new">Homologene</a>
    </td>
  </tr>
